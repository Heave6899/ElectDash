...
@Component({
  selector: 'app-linechart-vb',
  templateUrl: './linechart-vb.component.html',
  styleUrls: ['./linechart-vb.component.css'],
})
export class LinechartVBComponent implements OnDestroy, OnInit {
  // messages =
  //   {
  //     topic: '',
  //     timestamp: '',
