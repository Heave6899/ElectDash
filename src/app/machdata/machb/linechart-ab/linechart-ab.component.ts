...
@Component({
  selector: 'app-linechart-ab',
  templateUrl: './linechart-ab.component.html',
  styleUrls: ['./linechart-ab.component.css'],
})
export class LinechartABComponent implements OnDestroy {
  messages =
    {
      topic: '',
      timestamp: '',
    ...
    constructor(private messageService:SseService) {
        ...
        this.subscription = this.messageService.getMessageB().subscribe(message => {
          if(message){
          this.messages = {
            topic: message.topic,
        ...
        //if(this.messages.topic == 'pibpump/b')
