...
@Component({
  selector: 'app-linechart-vf',
  templateUrl: './linechart-vf.component.html',
  styleUrls: ['./linechart-vf.component.css'],
})
export class LinechartVFComponent implements OnDestroy, OnInit {
  // messages =
  //   {
  //     topic: '',
  //     timestamp: '',
