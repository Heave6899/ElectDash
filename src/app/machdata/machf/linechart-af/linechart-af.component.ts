...
@Component({
  selector: 'app-linechart-af',
  templateUrl: './linechart-af.component.html',
  styleUrls: ['./linechart-af.component.css'],
})
export class LinechartAFComponent implements OnDestroy {
  messages =
    {
      topic: '',
      timestamp: '',
    ...
    constructor(private messageService:SseService) {
        ...
        this.subscription = this.messageService.getMessageF().subscribe(message => {
          if(message){
          this.messages = {
            topic: message.topic,
        ...
        //if(this.messages.topic == 'pibpump/f')
