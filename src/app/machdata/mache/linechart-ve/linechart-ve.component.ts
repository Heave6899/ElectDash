...
@Component({
  selector: 'app-linechart-ve',
  templateUrl: './linechart-ve.component.html',
  styleUrls: ['./linechart-ve.component.css'],
})
export class LinechartVEComponent implements OnDestroy, OnInit {
  // messages =
  //   {
  //     topic: '',
  //     timestamp: '',
  ...
  //   };
    ...
    constructor(      private messageService : SseService      ){
      ...
      this.subscription = this.messageService.getMessageE().subscribe(message => {
      //console.log(message);
      if(message){
    //   this.message = {
    //      data: message.data,
