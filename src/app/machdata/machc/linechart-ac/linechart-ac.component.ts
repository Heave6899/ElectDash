...
@Component({
  selector: 'app-linechart-ac',
  templateUrl: './linechart-ac.component.html',
  styleUrls: ['./linechart-ac.component.css'],
})
export class LinechartACComponent implements OnDestroy {
  messages =
    {
      topic: '',
      timestamp: '',
