...
@Component({
  selector: 'app-linechart-vc',
  templateUrl: './linechart-vc.component.html',
  styleUrls: ['./linechart-vc.component.css'],
})
export class LinechartVCComponent implements OnDestroy, OnInit {
  // messages =
  //   {
  //     topic: '',
  //     timestamp: '',
