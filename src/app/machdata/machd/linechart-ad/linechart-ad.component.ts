...
@Component({
  selector: 'app-linechart-ad',
  templateUrl: './linechart-ad.component.html',
  styleUrls: ['./linechart-ad.component.css'],
})
export class LinechartADComponent implements OnDestroy {
  messages =
    {
      topic: '',
      timestamp: '',
